...
public class ActionFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        add=view.findViewById(R.id.Fragment_Action_BTN_Add);
        search=view.findViewById(R.id.Fragment_Action_BTN_Search);
//
...
//                Toast.makeText(getActivity(), "Add New", Toast.LENGTH_SHORT).show();
                ...
                addRecordFragment=AddRecordFragment.newInstance();
                fragTrans.replace(R.id.FrameLayout_Right, addRecordFragment);
                fragTrans.commitNow();
            }
        });
...
//                Toast.makeText(getActivity(), "Add New", Toast.LENGTH_SHORT).show();
                ...
                fragTrans.replace(R.id.FrameLayout_Right, searchRecordFragment);
                fragTrans.commitNow();
            }
        });
